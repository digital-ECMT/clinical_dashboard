...
for(i in 1:length(subject_ids)) {
  ...
  for(j in 1:length(inpatient_dates)) {
    ...
    unit <- "mmol/L"
    # generate a value
    value <- round(rnorm(n=1, mean = 45, sd = 10), digits = 1)
    measurements_synth <- measurements_synth %>%
      add_row(
        SUBJECT_ID = subject_id, 
        MEASUREMENT_NAME = measurement, 
    ...
    unit <- "bpm"
    # generate a value
    value <- round(rnorm(n=1, mean = 70, sd = 10), digits = 1)
    measurements_synth <- measurements_synth %>%
      add_row(
        SUBJECT_ID = subject_id, 
        MEASUREMENT_NAME = measurement, 
    ...
    unit <- "mm Hg"
    # generate a value
    value <- round(rnorm(n=1, mean = 120, sd = 10), digits = 1)
    measurements_synth <- measurements_synth %>%
      add_row(
        SUBJECT_ID = subject_id, 
        MEASUREMENT_NAME = measurement, 
    ...
    unit <- "mm Hg"
    # generate a value
    value <- round(rnorm(n=1, mean = 80, sd = 10), digits = 1)
    measurements_synth <- measurements_synth %>%
      add_row(
        SUBJECT_ID = subject_id, 
        MEASUREMENT_NAME = measurement, 
